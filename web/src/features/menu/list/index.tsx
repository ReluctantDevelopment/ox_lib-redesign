...
const useStyles = createStyles((theme, params: { position?: MenuPosition; itemCount: number; selected: number }) => ({
  tooltip: {
    background: 'linear-gradient(180deg, rgba(12, 33, 58, 0.96) 0%, rgba(8, 24, 44, 0.96) 100%)',
    color: '#c7e5ff',
    borderRadius: theme.radius.sm,
    maxWidth: 350,
    whiteSpace: 'normal',
    border: '1px solid rgba(83, 149, 241, 0.45)',
  ...
  buttonsWrapper: {
    ...
    border: '1px solid rgba(83, 149, 241, 0.35)',
    borderTop: 'none',
